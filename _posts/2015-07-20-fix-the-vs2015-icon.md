...
Note you can also shift-right-click and change the icon directly on the taskbar, or you can visit `C:\Users\yourusername\AppData\Roaming\Microsoft\Internet Explorer\Quick Launch\User Pinned\TaskBar` and change the icon there, too, but doing that seems to generally require you to kill the Explorer process / reboot to get the taskbar to refresh. The above way doesn't... but is also a Windows 7 solution. YMMV.